...
// WIDGET PARAMETER: small|https://www.insidexbox.de|InsideXbox.de|background.jpg
// parameter order has to be: widget size, site url, site name, background image
// parameters have to be separated by |
// You can omit parameters, for example background image: small|https://www.insidexbox.de|InsideXbox.de
...
var SITE_URL = 'https://www.insidexbox.de';; // address of the website to fetch posts from
var SITE_NAME = 'InsideXbox.de'; // name to display in the widget
